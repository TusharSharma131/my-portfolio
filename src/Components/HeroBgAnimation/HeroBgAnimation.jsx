...
const HeroBgAnimation = () => (
  <div className="relative flex justify-end items-start w-full h-screen bg-black">
    <div className="absolute inset-0 flex justify-end items-start overflow-hidden ">
      <svg
        className="absolute top-0 left-0 w-full h-full max-w-2xl mx-auto"
        viewBox="0 0 602 602"
        fill="none"
